...
namespace OpenFeira.Data.Models.Context;

public partial class OpenFeiraDatabaseContext : DbContext
{
    /*
     * Entity Framework database context scaffold command:
     * 
     * dotnet ef dbcontext scaffold
     * "Server=DESKTOP-6VQGLAV\SQLEXPRESS;Database=OpenFeiraDB;Trusted_Connection=True;Integrated Security=true;TrustServerCertificate=True;"
     * Microsoft.EntityFrameworkCore.SqlServer
     * -c OpenFeiraDatabaseContext
     * -o Models
     * --force
     *
     * To not expose the connection string we can do the following:
     * 
    ...
    public OpenFeiraDatabaseContext()
    {
    }

    public OpenFeiraDatabaseContext(DbContextOptions<OpenFeiraDatabaseContext> options)
        : base(options)
    {
    }
    ...
    {
        // Warning: Make sure you have your database connection string in 'appsettings.json'.
        
        // Getting the 'appsettings.json' configuration file, in order to obtain the database connection string.
        var configuration = new ConfigurationBuilder()
            .SetBasePath(Directory.GetCurrentDirectory())
            .AddJsonFile("appsettings.json")
            .Build();

        // Fetching the connection string for database 'OpenFeiraDB'.
        var connectionString = configuration.GetConnectionString("OpenFeiraDB");
